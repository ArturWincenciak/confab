...
{
    public sealed record GetAgenda(Guid ConferenceId) : IRequestMessage<GetAgenda.Result>, IModuleRequest
    {
        public class Result : IEnumerable<Result.AgendaTrackDto>, IResponseMessage, IModuleResponse
        {
