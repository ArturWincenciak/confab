...
internal class TestingApplication
{
        ...
        CreateAgendaSlot createAgendaSlotCommand, string createdSlotResourceId, SpeakerDto inputSpeakerDto)
    {
        ...
        _testResult = new(
            signUpUser,
            inputHostDto,
            createdHostId: ResolveHostId(),
            inputConferenceDto,
            createTrackCommand,
            createdConferenceId: ResolveConferenceId(),
            createdTrackId: ResolveTrackId(createdTrackResourceId));
    }
    ...
    private Guid ResolveConferenceId() =>
        ResolveIdByLocationUrl(_createdConferenceLocation);

    private Guid ResolveHostId() =>
        ResolveIdByLocationUrl(_createdHostLocation);
