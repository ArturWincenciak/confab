...
public class AttendableEventAttendTests
{
    ...
    private void Arrange()
    {
        ...
        var from = new DateTime(year: 2022, month: 2, day: 6, hour: 11, minute: 0, second: 0);
        var to = new DateTime(year: 2022, month: 2, day: 6, hour: 12, minute: 0, second: 0);
        ...
        _participant_1 = Participant.Create(_conferenceId, userId_1);
        _slot_1 = new(Guid.Parse("39720949-CD62-4EFA-B1C8-ABBDF8F7334B"));
    }
    ...
    private void WithSecondParticipant()
    {
        ...
        _participant_2 = Participant.Create(_conferenceId, userId_2);
    }

    private Attendance Act() =>
        _target.Attend(_participant_1);

    private Attendance Act(Participant participant) =>
        _target.Attend(participant);
